...
router.post('/', async (request: Request<{}, {}, SubscriptionPlanInput>, response: Response) => {
    try {
...
router.put('/:id', async (request: Request<{ id: string }, {}, SubscriptionPlanUpdateInput>, response: Response) => {
    try {
